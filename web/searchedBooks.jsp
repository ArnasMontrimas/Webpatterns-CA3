...
<%
    ...
    // List of books corresponding to research
      ...
      <main class="container pt-3 pb-5" id="booksPage">
        <div class="row justify-content-between">
          ...
          <form action="controller" method="post" class="d-flex col-sm-8 col-lg-5 mb-2 mb-sm-0">
            ...
            <input class="form-control me-2" type="search" name="query" placeholder="Search for books" aria-label="Search" required value="<%= query %>">
